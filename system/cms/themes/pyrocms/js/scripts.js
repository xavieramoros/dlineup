...
jQuery(function($) {
	...
	// Create a clean slug from whatever garbage is in the title field, without waiting for edit the title.
	pyro.generate_slug_now = function(input_form, output_form, space_character, disallow_dashes)
	{
		var slug, value;
